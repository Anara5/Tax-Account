...
public class Main {
    ...
    private static int taxIncomes(int incomes) { //method to count tax1 option
        int tax1 =  incomes * 6 / 100;
        return tax1;
    }

    private static int taxIncomesMinusExpenses(int incomes, int expenses) { //method to count tax2 option
    ...
    private static void toSave(int tax1, int tax2) { //method for counting how much we will safe with certain tax option
